...
@section('content')
    ...
    <section class="contact-us">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-section-title px-4">
                        {!! $ps->contact_title !!}
                        {!! $ps->contact_text !!}
                    </div>
                </div>
                        ...
                        <div class="contact-form">
                            ...
                            <form id="contactform" action="{{ route('front.contact.submit') }}" method="POST">
                                ...
                                <div class="form-input">
                                    <input type="text" class="bg-light text-dark shadow-sm" name="name" placeholder="{{ __('Name') }} *" required="">
                                    <i class="icofont-user-alt-5"></i>
                                </div>
                                <div class="form-input">
                                    <input type="text" class="bg-light text-dark shadow-sm" name="phone" placeholder="{{ __('Phone Number') }} *">
                                    <i class="icofont-ui-call"></i>
                                </div>
                                <div class="form-input">
                                    <input type="email" class="bg-light text-dark shadow-sm" name="email" placeholder="{{ __('Email Address') }} *"
                                        required="">
                                    <i class="icofont-email"></i>
                                </div>
                                <div class="form-input">
                                    <textarea name="text" class="bg-light text-dark shadow-sm" placeholder="{{ __('Your Message') }} *" required=""></textarea>
                                </div>
                                ...
                                <button class="submit-btn bg-light text-dark border-0 shadow-sm" type="submit">{{ __('Send Message') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
