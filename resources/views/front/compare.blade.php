                ...
                <div class="content">
                    ...
                    <div class="compare-page-content-wrap">
                        <div class="compare-table">
                            <table class="table table-bordered mb-0 table-responsive-sm">
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="c{{$product['item']['id']}}">
                                            ...
                                            <a href="{{ route('affiliate.product', $product['item']['slug']) }}"
                                                class="add-to-cart-btn bg-light text-dark shadow-sm px-4 py-2">{{ __("Buy Now") }}</a>
                                            @else

                                            <a href="javascript:;"
                                                data-href="{{ route('product.cart.add',$product['item']['id']) }}"
                                                class="add-to-cart-btn bg-light text-dark shadow-sm px-4 py-2 mb-2 mb-xl-0">{{ __("Add To Cart") }}</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-remove c{{$product['item']['id']}}">
                                            <button class='bg-light text-dark shadow-sm px-2 border-0 outline-0 py-2 px-3'>
                                                <i class="far fa-trash-alt compare-remove border-none outline-none" data-href="{{ route('product.compare.remove', $product['item']['id']) }}" data-class="c{{$product['item']['id']}}"></i>
                                            </button>
                                        </td>
                                        @endforeach
                                    </tr>
