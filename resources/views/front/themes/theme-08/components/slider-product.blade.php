            ...
            <ul>
                <li>
                    ...
                    <span class="add-to-wish" data-href="{{ route('user-wishlist-add',$prod->id) }}"
                        ...
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 448.45 448.45"
                    ...
                    <span rel-toggle="tooltip" title="{{ __('Add To Wishlist') }}" data-toggle="modal" id="wish-btn"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="31.167" viewBox="0 0 35 31.167">
                ...
                <li>
                    <span class="add-to-compare" data-href="{{ route('product.compare.add',$prod->id) }}"
                        data-toggle="tooltip" data-placement="right" title="{{ __('Compare') }}" data-placement="right">
...
<a href="{{ route('front.product', $prod->slug) }}" class="item">
            ...
            <ul>
                <li>
                    ...
                    <span class="add-to-wish" data-href="{{ route('user-wishlist-add',$prod->id) }}"
                        data-toggle="tooltip" data-placement="right" title="{{ __('Add To Wishlist') }}"
                        data-placement="right">
                        <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 35 31.167">
                            <g transform="translate(-3.999 -1025.989)">
                                <path
                                    d="M29.2,5.627a9.758,9.758,0,0,0-6.932,2.885l-.766.769-.766-.769a9.774,9.774,0,0,0-13.862,0,9.85,9.85,0,0,0,0,13.9L8.156,23.7,20.984,36.58a.729.729,0,0,0,1.031,0L34.843,23.7l1.285-1.287a9.85,9.85,0,0,0,0-13.9A9.751,9.751,0,0,0,29.2,5.627ZM13.8,7.074a8.3,8.3,0,0,1,5.9,2.469l1.285,1.287a.729.729,0,0,0,1.031,0L23.3,9.543a8.281,8.281,0,0,1,11.794,0,8.365,8.365,0,0,1,0,11.845l-1.282,1.287L21.5,35.034,9.187,22.676,7.905,21.388A8.392,8.392,0,0,1,13.8,7.074Zm.04,1.472a6.927,6.927,0,0,0-6,10.39.729.729,0,1,0,1.262-.729A5.468,5.468,0,0,1,13.843,10a.729.729,0,1,0,0-1.458Z"
                                    transform="translate(0 1020.362)" fill-rule="evenodd" />
    ...
    <div class="info">
        <h5 class="name">{{ $prod->showName() }}</h5>
        <h4 class="price">{{ $highlight }} @if($curr->id != $scurrency->id)<br><small>{{ $small }}</small> @endif</h4>
    </div>
    @if($gs->is_cart)
    <div class="item-cart-area">
        @if($prod->product_type == "affiliate")
