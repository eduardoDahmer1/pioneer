                    ...
                    <ul class="link-list">
                        <li>
                            <a href="{{ route('front.index') }}">
                                <i class="fas fa-caret-right"></i>{{ __('Home') }}
                            </a>
                        </li>
                        ...
                        @foreach ($pfooter as $data)
                            <li>
                                <a href="{{ route('front.page', $data->slug) }}">
                                    <i class="fas fa-caret-right"></i>{{ $data->title }}
                                </a>
                            </li>
                        @endforeach
                        ...
                        <li>
                            <a href="{{ route('front.contact') }}">
                                <i class="fas fa-caret-right"></i>{{ __('Contact Us') }}
                            </a>
                        </li>
                        @if ($gs->crow_policy)
                            <li>
                                <a href="{{ route('front.crowpolicy') }}">
                                    <i class="fas fa-caret-right"></i>{{ __('General Terms of Service') }}
                                </a>
                            </li>
                        @endif
                        @if ($gs->privacy_policy)
                            <li>
                                <a href="{{ route('front.privacypolicy') }}">
                                    <i class="fas fa-caret-right"></i>{{ __('Privacy Policy') }}
                                </a>
                            </li>
                        @endif
                        @if ($gs->bank_check)
                            <li>
                                <a href="{{ route('front.receipt') }}">
                                    <i class="fas fa-caret-right"></i>{{ __('Upload Order Receipt') }}
                                </a>
                            </li>
                        @endif
                        @if ($gs->team_show_footer == 1)
                            <li>
                                <a href="{{ route('front.team_member') }}">
                                    <i class="fas fa-caret-right"></i>{{ __('Team') }}
                                </a>
                            </li>
                        @endif
