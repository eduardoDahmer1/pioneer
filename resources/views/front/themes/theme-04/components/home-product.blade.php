...
@if($prod->vendorPrice() <= $_GET['max']) <div class="col-lg-3 col-md-3 col-6 remove-padding">
    ...
    <a href="{{ route('front.product', $prod->slug) }}" class="item">
        ...
        @endif
        <div class="info">
            <h4 class="price">{{ $highlight }} @if($curr->id != $scurrency->id)<br><small><span id="originalprice">{{
    ...
    <div class="col-lg-3 col-md-3 col-6 remove-padding">
        ...
        <a href="{{ route('front.product', $prod->slug) }}" class="item">
            ...
            <div class="info">
                ...
                <h4 class="price">{{ $highlight }} @if($curr->id != $scurrency->id)<br><small><span
                            id="originalprice">{{ $small }}</span></small>@endif</h4>
                <h5 class="name">{{ $prod->showName() }}</h5>
