...
<section class="login-signup">
    <div class="container">
        <div class="row justify-content-center m-0 remove-padding">
            <div class="col-lg-6 shadow remove-padding m-0">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-log" role="tabpanel" aria-labelledby="nav-log-tab">
                        <div class="login-area shadow-none">
                            ...
                            <div class="login-form signin-form">
                                ...
                                <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
                                    ...
                                    <button type="submit" class="submit-btn shadow-sm">{{ __("Login") }}</button>
                        ...
                        <div class="login-area signup-area">
                            ...
                            <div class="login-form signup-form">
                                ...
                                <form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">
                                    ...
                                    <button type="submit" class="submit-btn shadow-sm">{{ __("Register") }}</button>
