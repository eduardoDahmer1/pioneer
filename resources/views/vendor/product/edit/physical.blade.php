...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            let html =
            `<img src="{{ (basename($data->photo) !== 'noimage.png' && $data->photo && !filter_var($data->photo, FILTER_VALIDATE_URL)) ? asset('storage/images/products/' . $data->photo) : (basename($data->photo) !== 'noimage.png' && $data->photo && filter_var($data->photo, FILTER_VALIDATE_URL) ? $data->photo) : ((isset($data->galleries[0]) && filter_var($data->galleries[0]->photo, FILTER_VALIDATE_URL)) ? $data->galleries[0]->photo : (isset($data->galleries[0]) ? asset('storage/images/galleries/' . $data->galleries[0]->photo) : asset('storage/assets/images/noimage.png'))) }}" alt="">`;
