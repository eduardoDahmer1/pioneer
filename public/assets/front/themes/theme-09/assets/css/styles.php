...
.logo-header .helpful-links ul li .wish i, .logo-header .helpful-links ul li.my-dropdown .cart .icon i { color: <?php echo $theme_color_2; ?>; } .logo-header .search-box .categori-container .categoris option { background: <?php echo $theme_color_2; ?>; } .autocomplete-items div { background: <?php echo "#fff"; ?>; border: 0.5px solid <?php echo "#fff"; ?>; z-index: 100; } .bottomtotop i { color: <?php echo $text_color_1; ?>; }
...
.item .add-to-cart-btn{
    background: #f9f9f9;
    border: 1px solid <?php echo "none" ?>;
    color: <?php echo $text_color_2; ?>;
}
...
.product-details-page .categori .owl-carousel .owl-controls .owl-nav .owl-next:hover {
    background: #9d0013 !important;
    box-shadow: 0px 1px 4px rbga(68, 68, 68, 0.091);
}
